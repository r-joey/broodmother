...
class AnsonsPhStrategy(SpiderStrategy):
    ...
    def execute(self):
        ...
        while True:
            ...
            if raw_data:
                ...
                product_tags = soup.select('main#main ul.products > li')
                next_page = soup.select_one('main#main nav.electro-advanced-pagination > a')
    ...
    def _get_price(self, product_tag: BeautifulSoup):
        ...
        try:
            price_tag = product_tag.select_one('ins span.woocommerce-Price-amount.amount') or product_tag.select_one('.electro-price span.woocommerce-Price-amount.amount')
            if price_tag:
    ...
    def _image_url(self, product_tag: BeautifulSoup):
        ...
        try:
            ...
            if image_tag and image_tag.has_attr('data-lazy-src'):
                value = image_tag['data-lazy-src']
        except Exception as e:
            value = 'FAILED'
            self.logger.exception(e)
